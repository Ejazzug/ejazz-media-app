...
const styles = StyleSheet.create({
  ...
  topButton: { width: 42, height: 42, alignItems: 'center', justifyContent: 'center', backgroundColor: '#13161E' },
  heroImage: { width: '100%', height: 290 },
  article: { paddingHorizontal: 20, paddingTop: 27 },
  category: { color: '#F2B86B', fontSize: 10, fontWeight: '700', letterSpacing: 1.5 },
  title: { color: '#F5F1E9', fontSize: 34, lineHeight: 39, fontWeight: '700', letterSpacing: -1.3, marginTop: 11 },
  byline: { flexDirection: 'row', alignItems: 'center', gap: 8, marginTop: 16 },
  bylineText: { color: '#6F7685', fontSize: 10, fontWeight: '700', letterSpacing: 1.1 },
  bylineDot: { color: '#3E79FF' },
  lede: { color: '#F5F1E9', fontSize: 18, lineHeight: 27, fontWeight: '600', marginTop: 28 },
  body: { color: '#B3B7C0', fontSize: 16, lineHeight: 27, marginTop: 22 },
  pullQuote: { color: '#3E79FF', fontSize: 25, lineHeight: 31, fontWeight: '700', letterSpacing: -0.7, borderLeftWidth: 3, borderLeftColor: '#F2B86B', paddingLeft: 16, marginTop: 30 },
  related: { marginTop: 39, paddingHorizontal: 20, paddingTop: 24, borderTopWidth: 1, borderTopColor: '#282D38' },
  relatedLabel: { color: '#9298A6', fontSize: 10, fontWeight: '700', letterSpacing: 1.5, marginBottom: 17 },
  relatedItem: { flexDirection: 'row', alignItems: 'center', gap: 13, marginBottom: 15 },
  relatedImage: { width: 80, height: 70 },
  relatedTitle: { color: '#F5F1E9', fontSize: 14, lineHeight: 19, fontWeight: '600', flex: 1 },
});